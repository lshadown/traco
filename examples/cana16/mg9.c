    ...
    for (c2 = 0; c2 <= floord(N8 - 1, 16); c2 += 1) {
      ...
      for (c4 = 0; c4 <= floord(N11 - 1, 16); c4 += 1)
        for (c6 = N1 + 16 * c0; c6 <= min(N2, N1 + 16 * c0 + 15); c6 += 1) {
          ...
          for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N8); c8 += 1)
            for (c10 = 16 * c4 + 1; c10 <= min(16 * c4 + 16, N11); c10 += 1)
...
if (N8 >= 1 && N11 >= 1) {
  for (c0 = 0; c0 <= floord(-N1 + N2, 16); c0 += 1) {
    for (c2 = 0; c2 <= floord(N8 - 1, 16); c2 += 1) {
      ...
      for (c4 = 0; c4 <= floord(N11 - 1, 16); c4 += 1) {
        for (c6 = N3 + 16 * c2; c6 <= min(min(N4, 16 * c2), N3 + 16 * c2 + 15); c6 += 1)
        ...
        for (c6 = 16 * c2 + 1; c6 <= min(16 * c2 + 16, N8); c6 += 1) {
          if (N4 >= c6 && N3 + 16 * c2 + 15 >= c6 && c6 >= N3 + 16 * c2)
            for (c8 = 16 * c4 + 1; c8 <= min(N7, 16 * c4 + 16); c8 += 1)
              for (c10 = N1 + 16 * c0; c10 <= min(N2, N1 + 16 * c0 + 15); c10 += 1)
                u[2*c8-t1][2*c6-d2][2*c10-d3]=u[2*c8-t1][2*c6-d2][2*c10-d3]+0.5*(z[c8+1][c6][c10]+z[c8][c6][c10]);
          for (c8 = 16 * c4 + 1; c8 <= min(16 * c4 + 16, N11); c8 += 1)
            for (c10 = N1 + 16 * c0; c10 <= min(N2, N1 + 16 * c0 + 15); c10 += 1)
              u[2*c8-t1][2*c6-t2][2*c10-d3]=u[2*c8-t1][2*c6-t2][2*c10-d3]+0.25*(z[c8+1][c6+1][c10]+z[c8+1][c6][c10]+z[c8][c6+1][c10]+z[c8][c6][c10]);
        }
        for (c6 = max(N3 + 16 * c2, N8 + 1); c6 <= min(min(16 * c2 + 16, N3 + 16 * c2 + 15), N4); c6 += 1)
          for (c8 = 16 * c4 + 1; c8 <= min(N7, 16 * c4 + 16); c8 += 1)
            for (c10 = N1 + 16 * c0; c10 <= min(N2, N1 + 16 * c0 + 15); c10 += 1)
              u[2*c8-t1][2*c6-d2][2*c10-d3]=u[2*c8-t1][2*c6-d2][2*c10-d3]+0.5*(z[c8+1][c6][c10]+z[c8][c6][c10]);
        for (c6 = max(16 * c2 + 17, N3 + 16 * c2); c6 <= min(N4, N3 + 16 * c2 + 15); c6 += 1)
          for (c8 = 16 * c4 + 1; c8 <= min(N7, 16 * c4 + 16); c8 += 1)
            for (c10 = N1 + 16 * c0; c10 <= min(N2, N1 + 16 * c0 + 15); c10 += 1)
              u[2*c8-t1][2*c6-d2][2*c10-d3]=u[2*c8-t1][2*c6-d2][2*c10-d3]+0.5*(z[c8+1][c6][c10]+z[c8][c6][c10]);
      }
    ...
    if (N7 <= 0) {
      ...
      for (c2 = (N8 - 1) / 16 + 1; c2 <= floord(-N3 + N4, 16); c2 += 1) {
        ...
        for (c4 = 0; c4 <= floord(N7 - 1, 16); c4 += 1)
          for (c6 = N3 + 16 * c2; c6 <= min(N3 + 16 * c2 + 15, N4); c6 += 1)
            for (c8 = 16 * c4 + 1; c8 <= min(16 * c4 + 16, N7); c8 += 1)
              for (c10 = N1 + 16 * c0; c10 <= min(N2, N1 + 16 * c0 + 15); c10 += 1)
                u[2*c8-t1][2*c6-d2][2*c10-d3]=u[2*c8-t1][2*c6-d2][2*c10-d3]+0.5*(z[c8+1][c6][c10]+z[c8][c6][c10]);
      }
    for (c2 = 0; c2 <= floord(N8 - 1, 16); c2 += 1)
