...
for (c0 = 0; c0 <= floord(N1 - 1, 16); c0 += 1)
  for (c2 = 0; c2 <= floord(N2 - 1, 16); c2 += 1) {
    for (c6 = 16 * c0 + 1; c6 <= min(16 * c0 + 16, N1); c6 += 1)
      for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N2); c8 += 1) {
        y[c8][1][c6]=x1[c8][1][c6];
        y[c8][2][c6]=0;
      }
    for (c4 = 0; c4 <= floord(N3 - 1, 16); c4 += 1)
      for (c6 = 16 * c0 + 1; c6 <= min(16 * c0 + 16, N1); c6 += 1)
        for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N2); c8 += 1)
          for (c10 = 16 * c4 + 1; c10 <= min(16 * c4 + 16, N3); c10 += 1)
            y[c8][2][c6]=y[c8][2][c6]+map2[c10]*x1[c8][c10][c6];
    if (N3 >= 1)
      for (c6 = 16 * c0 + 1; c6 <= min(16 * c0 + 16, N1); c6 += 1)
        for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N2); c8 += 1) {
          y[c8][3][c6]=x1[c8][lx1][c6];
          y[c8][4][c6]=0;
        }
    for (c4 = 0; c4 <= floord(N4 - 1, 16); c4 += 1)
      for (c6 = 16 * c0 + 1; c6 <= min(16 * c0 + 16, N1); c6 += 1)
        for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N2); c8 += 1)
          for (c10 = 16 * c4 + 1; c10 <= min(16 * c4 + 16, N4); c10 += 1)
            y[c8][4][c6]=y[c8][4][c6]+map4[c10]*x2[c8][c10][c6];
    if (N3 >= 1)
      for (c6 = 16 * c0 + 1; c6 <= min(16 * c0 + 16, N1); c6 += 1)
        for (c8 = 16 * c2 + 1; c8 <= min(16 * c2 + 16, N2); c8 += 1)
          y[c8][lx1][c6]=x2[c8][lx1][c6];
  }
...
for (c0 = 0; c0 <= floord(N1 - 1, 16); c0 += 1)
  for (c2 = 0; c2 <= floord(N2 - 1, 16); c2 += 1) {
    for (c6 = 16 * c2 + 1; c6 <= min(16 * c2 + 16, N2); c6 += 1)
      for (c10 = 16 * c0 + 1; c10 <= min(16 * c0 + 16, N1); c10 += 1) {
        y[c6][1][c10]=x1[c6][1][c10];
        y[c6][2][c10]=0;
      }
    for (c4 = 0; c4 <= floord(N3 - 1, 16); c4 += 1)
      for (c6 = 16 * c2 + 1; c6 <= min(16 * c2 + 16, N2); c6 += 1)
        for (c8 = 16 * c4 + 1; c8 <= min(16 * c4 + 16, N3); c8 += 1)
          for (c10 = 16 * c0 + 1; c10 <= min(16 * c0 + 16, N1); c10 += 1)
    ...
    for (c4 = 0; c4 <= floord(N4 - 1, 16); c4 += 1)
      for (c6 = 16 * c2 + 1; c6 <= min(16 * c2 + 16, N2); c6 += 1)
        for (c8 = 16 * c4 + 1; c8 <= min(16 * c4 + 16, N4); c8 += 1)
          for (c10 = 16 * c0 + 1; c10 <= min(16 * c0 + 16, N1); c10 += 1)
