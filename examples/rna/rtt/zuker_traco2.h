          ...
          for( c9 = -N + 16 * c1 - 16 * c3 + 1; c9 <= min(0, -N + 16 * c1 - 16 * c3 + 16); c9 += 1) {
            if (N + 16 * c3 + c9 >= 16 * c1 + 2) {
              ...
              for( c11 = max(N - 16 * c1 + 32 * c3, N - 16 * c1 + 16 * c3 + 16 * c5 + 2); c11 <= N - 16 * c1 + 32 * c3 + 15; c11 += 1) {
                V[(N-16*c1+16*c3-1)][c11] = MIN(W[(N-16*c1+16*c3-1)+1][(N-16*c1+16*c3+16*c5)] + W[(N-16*c1+16*c3+16*c5)+1][c11-1], V[(N-16*c1+16*c3-1)][c11]);
                for( c13 = N - 16 * c1 + 16 * c3 + 16 * c5 + 1; c13 <= min(N - 16 * c1 + 16 * c3 + 16 * c5 + 15, c11 - 2); c13 += 1) {
                  for( c15 = c13 + 1; c15 < c11; c15 += 1)
